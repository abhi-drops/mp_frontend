  ...
  return (
    ...
    <div className='w-[100vw] md:h-[85vh] h-[82vh] md:px-40 px-3 overflow-x-hidden'>
       ...
       <h2 className='text-2xl font-semibold text-info ms-5 py-5'>Today's Lineup </h2>
         ...
         <CardEvents className=" h-[100%]" note="Anyone up for coffee this Saturday? New to the city and looking to meet some people " like="75" />
         <CardEvents className=" h-[100%]" note="Looking for a part-time web developer. DM me for details!" like="5" />
         </div>

         <div className=' w-full md:flex grid gap-3 pb-3 md:pb-0 md:gap-0 '>

         <CardEvents className=" h-[100%]" note="Free furniture! Moving out and need to get rid of some stuff." like="15" />
         <CardEvents className=" h-[100%] " note="Any cool hidden gems around the city I should check out?" like="10" />
         </div>

         <div className=' w-full md:flex grid gap-3 pb-3 md:pb-0 md:gap-0 '>

         <CardEvents className=" h-[100%]" note="Urgent: Blood drive today at the downtown hospital. Come donate!" like="15" />
         <CardEvents className=" h-[100%]" note="Any cool hidden gems around the city I should check out?" like="10" />
         </div>
